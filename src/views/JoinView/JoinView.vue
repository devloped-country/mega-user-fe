<template>
  ...
  <input type="password" id="password" name="password" v-model="password" @input="validatePassword" required placeholder="비밀번호 *">
  ...
  <input type="password" id="confirmPassword" name="confirmPassword" v-model="confirmPassword" @input="checkPasswordMatch" required placeholder="비밀번호 확인 *">
